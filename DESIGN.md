...
description: "Kanakku is a Sales, Invoices & Accounts Admin template for Accountant or Companies/Offices with various features for all your needs. Try Demo and Buy Now."
sourceUrl: "https://preadmin.dreamstechnologies.com"
...
shadows:
  card: "rgba(0, 0, 0, 0) 0px 0px 0px 9999px inset"
  elevated: "rgba(0, 0, 0, 0) 0px 0px 0px 9999px inset"
...
breakpoints: [420px, 564px, 576px, 730px, 768px, 992px, 1200px, 1400px]
---

## Rationale

Measured design tokens extracted from https://preadmin.dreamstechnologies.com. The frontmatter above is the design system — real colors, type scale, spacing, radius, shadows, motion, and breakpoints read from the live page. Upgrade to Pro for the full written system (rationale, component guidance, and accessibility notes).
